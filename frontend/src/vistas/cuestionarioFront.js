...
import './perfil.css'; // Archivo de estilos CSS para la vista
...
const Vacantes = () => {
  return (
    <div className="vacantes-container">
      ...
      <br></br>
      <h1 className="section-title">Cuestionario para Especialista en Frontend</h1>


      {/* Cuerpo con los tres recuadros */}
      <div className="vacantes-body">
        <div className="box" onClick={() => window.location.href = '/vacante1'}>
          HTML/CSS
        </div>
